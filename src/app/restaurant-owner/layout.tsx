...
const sidebarLinks = [
  { name: "Dashboard", href: "/restaurant-owner", icon: LayoutDashboard },
  { name: "Restaurant Profile", href: "/restaurant-owner/restaurant", icon: Store },
  { name: "Categories", href: "/restaurant-owner/categories", icon: MenuSquare },
  { name: "Menu Items", href: "/restaurant-owner/menu", icon: UtensilsCrossed },
  { name: "Orders", href: "/restaurant-owner/orders", icon: ClipboardList },
];
      ...
      <div className="p-4 border-t border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center space-x-3 mb-4 px-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-zinc-500 truncate">Restaurant Owner</p>
          </div>
        </div>
