...
const sidebarLinks = [
  ...
  { name: "Live Orders", href: "/delivery/orders", icon: MapPin },
];
    ...
    <div className="flex h-full flex-col border-r border-slate-800 bg-slate-950/95 text-slate-50 backdrop-blur-xl">
      <div className="border-b border-slate-800 p-6">
        <div className="flex items-center gap-3">
          <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-purple-500/15 text-lg ring-1 ring-purple-500/20">🛵</span>
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-purple-300">Delivery Hub</p>
            <p className="text-sm text-slate-400">Clean routing and order visibility</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-slate-800 p-4">
        <div className="mb-4 rounded-2xl border border-slate-800 bg-slate-900/70 px-3 py-3">
          ...
          <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold overflow-hidden flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-400 truncate">Rider App</p>
          </div>
        </div>
        </div>
